...
Design the **data model** for a _recipe book_ application, then use `Knex migrations and seeding` functionality to build a postgreSQL (or SQLite3) database based on the model and seed it with test data.
